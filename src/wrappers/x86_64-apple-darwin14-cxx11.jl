# Autogenerated wrapper script for OpenCV_jll for x86_64-apple-darwin14-cxx11
...
const libopencv_calib3d_splitpath = ["lib", "libopencv_calib3d.4.5.0.dylib"]
...
const libopencv_calib3d = "@rpath/libopencv_calib3d.4.5.dylib"


# Relative path to `libopencv_core`
const libopencv_core_splitpath = ["lib", "libopencv_core.4.5.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libopencv_core = "@rpath/libopencv_core.4.5.dylib"


# Relative path to `libopencv_dnn`
const libopencv_dnn_splitpath = ["lib", "libopencv_dnn.4.5.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libopencv_dnn = "@rpath/libopencv_dnn.4.5.dylib"


# Relative path to `libopencv_features2d`
const libopencv_features2d_splitpath = ["lib", "libopencv_features2d.4.5.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libopencv_features2d = "@rpath/libopencv_features2d.4.5.dylib"


# Relative path to `libopencv_flann`
const libopencv_flann_splitpath = ["lib", "libopencv_flann.4.5.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libopencv_flann = "@rpath/libopencv_flann.4.5.dylib"


# Relative path to `libopencv_gapi`
const libopencv_gapi_splitpath = ["lib", "libopencv_gapi.4.5.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libopencv_gapi = "@rpath/libopencv_gapi.4.5.dylib"


# Relative path to `libopencv_highgui`
const libopencv_highgui_splitpath = ["lib", "libopencv_highgui.4.5.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libopencv_highgui = "@rpath/libopencv_highgui.4.5.dylib"


# Relative path to `libopencv_imgcodecs`
const libopencv_imgcodecs_splitpath = ["lib", "libopencv_imgcodecs.4.5.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libopencv_imgcodecs = "@rpath/libopencv_imgcodecs.4.5.dylib"


# Relative path to `libopencv_imgproc`
const libopencv_imgproc_splitpath = ["lib", "libopencv_imgproc.4.5.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libopencv_imgproc = "@rpath/libopencv_imgproc.4.5.dylib"


# Relative path to `libopencv_ml`
const libopencv_ml_splitpath = ["lib", "libopencv_ml.4.5.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libopencv_ml = "@rpath/libopencv_ml.4.5.dylib"


# Relative path to `libopencv_objdetect`
const libopencv_objdetect_splitpath = ["lib", "libopencv_objdetect.4.5.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libopencv_objdetect = "@rpath/libopencv_objdetect.4.5.dylib"


# Relative path to `libopencv_photo`
const libopencv_photo_splitpath = ["lib", "libopencv_photo.4.5.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libopencv_photo = "@rpath/libopencv_photo.4.5.dylib"


# Relative path to `libopencv_stitching`
const libopencv_stitching_splitpath = ["lib", "libopencv_stitching.4.5.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libopencv_stitching = "@rpath/libopencv_stitching.4.5.dylib"


# Relative path to `libopencv_video`
const libopencv_video_splitpath = ["lib", "libopencv_video.4.5.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libopencv_video = "@rpath/libopencv_video.4.5.dylib"


# Relative path to `libopencv_videoio`
const libopencv_videoio_splitpath = ["lib", "libopencv_videoio.4.5.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libopencv_videoio = "@rpath/libopencv_videoio.4.5.dylib"
