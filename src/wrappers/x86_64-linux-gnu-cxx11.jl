# Autogenerated wrapper script for OpenCV_jll for x86_64-linux-gnu-cxx11
...
function __init__()
    ...
    foreach(p -> append!(PATH_list, p), (Qt_jll.PATH_list,))
    foreach(p -> append!(LIBPATH_list, p), (Qt_jll.LIBPATH_list,))
